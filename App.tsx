...
const App: React.FC = () => {
      ...
      <>
          {websiteSettings.layout.map(section => {
              ...
              switch(section.id) {
                  ...
                  case 'purchased': return purchasedProducts.length > 0 && <PurchasedProducts settings={websiteSettings} key={section.id} products={purchasedProducts} onViewPurchasedProduct={handleViewPurchasedProduct} onBack={handleBackToHome} />;
  ...
  const renderContent = () => {
    switch (currentView) {
      ...
      case 'myPurchases': return currentUser ? <PurchasedProducts settings={websiteSettings} products={purchasedProducts} onViewPurchasedProduct={handleViewPurchasedProduct} onBack={handleBackToHome} /> : <AuthPage settings={websiteSettings} onOtpAuthenticate={handleOtpAuthenticate} onBack={handleBackFromAuth} />;
