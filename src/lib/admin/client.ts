...
const SETTINGS_DEFAULTS:Record<string,any>={adminContent:{docsEditorAccess:"full",docsEditorAccessByType:{}},referralProgram:{enabled:true,discountPaise:25000,maxUsesPerReferrer:null}};
