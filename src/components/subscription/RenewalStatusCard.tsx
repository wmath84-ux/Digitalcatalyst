  ...
  return (
    ...
    >
      ...
      {!view.expired ? (
        ...
        <p className="mt-3 rounded-2xl bg-white/[0.08] px-3 py-2 text-xs font-semibold text-rose-200 ring-1 ring-rose-400/30">
      ...
      <div className="mt-3 flex items-center gap-2">
        {view.canRenew ? (
          <button
            ...
            className={`flex-1 rounded-2xl px-4 py-2.5 text-sm font-black text-white  transition active:scale-[0.98] ${tone.cta}`}
          >
            {view.cta}
          </button>
        ) : null}
        {onToggleReminders ? (
          <button
            ...
            className="flex shrink-0 items-center gap-1.5 rounded-2xl bg-white/[0.08] px-3 py-2.5 text-[11px] font-bold text-white/75 ring-1 ring-white/20 transition active:scale-[0.98]"
          >
