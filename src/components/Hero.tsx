  ...
  return (
    <section className="relative overflow-hidden px-4 pb-6 pt-6">
      <div className="relative">
        <GlassSurface radius={999} className="inline-block text-indigo-200" contentClassName="inline-flex items-center gap-1.5 px-3 py-1 text-[10px] font-black uppercase tracking-widest">
        ...
        <div className="mt-4 flex flex-wrap gap-2 [&>div]:inline-block">
          <GlassSurface radius={999} className="text-white/85" contentClassName="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold">
