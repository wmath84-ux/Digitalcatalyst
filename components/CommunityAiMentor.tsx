...
const CommunityAiMentor: React.FC<CommunityAiMentorProps> = ({ isOpen, userId = '', context, onClose, returnFocusRef }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1750] flex justify-end bg-[#081A45]/24 p-0 backdrop-blur-[3px] sm:p-3" role="dialog" aria-modal="true" aria-label="Community AI Mentor" ref={panelRef}>
      <div className="flex h-[100dvh] w-full min-w-0 flex-col overflow-hidden bg-[#F8FBFF] text-[#081A45] shadow-[0_30px_90px_rgba(8,26,69,0.22)] sm:h-[calc(100dvh-1.5rem)] sm:max-w-[520px] sm:rounded-[2rem] sm:border sm:border-[#D9E7F8]">
        ...
        <div className="relative flex min-h-0 flex-1 overflow-hidden">
          ...
          <main className="flex min-w-0 flex-1 flex-col">
            <div ref={messagesRef} className="flex-1 space-y-4 overflow-y-auto px-3 py-4 sm:px-5">
