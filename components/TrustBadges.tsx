...
const TrustBadges: React.FC<TrustBadgesProps> = ({ settings }) => {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_16%_22%,rgba(34,211,238,0.18),transparent_26%),radial-gradient(circle_at_85%_12%,rgba(59,130,246,0.22),transparent_28%),linear-gradient(180deg,rgba(15,23,42,0.98),rgba(2,6,23,1))]" />
      ...
      <div className="relative container mx-auto px-6">
        ...
        <div className="mt-12 grid grid-cols-1 gap-5 md:grid-cols-3">
          {trustItems.map((item) => (
            <article key={item.title} className="group relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.06] p-7 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.16),0_24px_70px_rgba(2,6,23,0.38)] backdrop-blur-2xl transition duration-300 hover:-translate-y-1 hover:border-cyan-200/35 hover:bg-white/[0.09]">
              ...
              <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl border border-white/10 bg-white/10 text-3xl shadow-[inset_0_1px_0_rgba(255,255,255,0.18)]">{item.icon}</div>
