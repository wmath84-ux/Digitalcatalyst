...
const OrderDetailsModal: React.FC<{ order: Order; onClose: () => void }> = ({ order, onClose }) => {
    return (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex justify-center items-center p-4 animate-fade-in" onClick={onClose}>
            <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-scale-in-up" onClick={e => e.stopPropagation()}>
        ...
        <div className="animate-fade-in-up">
            <div className="flex justify-between items-center mb-8">
                ...
                <button 
                    ...
                    className="bg-white/10 backdrop-blur-xl border border-slate-300 text-slate-700 font-semibold px-5 py-2.5 rounded-xl hover:bg-slate-50 transition-colors shadow-sm text-sm flex items-center gap-2"
                >
