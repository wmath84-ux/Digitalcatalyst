...
const ShieldIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-600" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 1.944A11.954 11.954 0 012.166 5.023L2 5.051a12.01 12.01 0 01-1 3.053c-.523 1.617-.955 3.256-1 4.887A12.01 12.01 0 012 14.949l.166.027a11.953 11.953 0 017.834 3.024l.05.044a11.953 11.953 0 017.834-3.024l.166-.027a12.01 12.01 0 013-1.999c.045-1.631.477-3.27.955-4.887a12.01 12.01 0 01-1-3.053l-.166-.027A11.954 11.954 0 0110 1.944zM9 13a1 1 0 112 0v1a1 1 0 11-2 0v-1zm1-4a1 1 0 00-1 1v2a1 1 0 102 0V10a1 1 0 00-1-1z" clipRule="evenodd" /></svg>;
const DocumentIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-600" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clipRule="evenodd" /></svg>;
const TruckIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-600" viewBox="0 0 20 20" fill="currentColor"><path d="M8 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM15 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" /><path d="M3 4a1 1 0 00-1 1v10a1 1 0 001 1h1.05a2.5 2.5 0 014.9 0H10a1 1 0 001-1V5a1 1 0 00-1-1H3zM14 7a1 1 0 00-1 1v5.05a2.5 2.5 0 014.9 0V8a1 1 0 00-1-1h-3.95z" /></svg>;
const PhoneIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-600" viewBox="0 0 20 20" fill="currentColor"><path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" /></svg>;
const RefundIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-slate-600" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1.707-11.707a1 1 0 00-1.414-1.414L6 9.586V7a1 1 0 00-2 0v5a1 1 0 001 1h5a1 1 0 000-2H8.414l3.293-3.293z" clipRule="evenodd" /></svg>;
...
const NotificationBanner: React.FC<{ notification: Notification; onClose: () => void }> = ({ notification, onClose }) => {
    ...
    return (
        <div className={`fixed top-8 right-8 z-50 p-4 border-l-4 rounded-lg shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex items-center gap-4 transition-transform transform translate-x-0 ${bgColor} ${textColor}`}>
            {icon}
        ...
        <div className="flex flex-col items-center">
            ...
            <div className="w-full max-w-3xl bg-white/80 backdrop-blur-xl p-8 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border">
                ...
                <div className="mt-8">
                    <button 
                        onClick={handleSave}
                        className="w-full bg-razorpay-light-blue text-slate-900 font-bold px-8 py-3 rounded-lg hover:bg-blue-700 transition-all duration-300"
                    >
                        Save and Continue
                    </button>
                </div>
