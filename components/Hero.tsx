...
const Hero: React.FC<HeroProps> = ({ settings, onNavigateToPolicies, onNavigateToAllProducts, onOpenBlogModal, onOpenFreeModal, onOpenAnnouncementsModal, realMetrics }) => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative isolate min-h-[92vh] overflow-hidden bg-sky-50 bg-gradient-to-br from-sky-50 via-indigo-100/60 to-violet-100 text-slate-900 stagger-animate-container flex items-center"
    >
      ...
      <div className="container relative z-10 mx-auto px-6 py-28 text-center">
        <div className="mx-auto max-w-5xl">
          <div className="animate-child animate-delay-1 inline-flex items-center gap-2 rounded-full border border-indigo-100/80 bg-white/80 px-5 py-2 text-sm font-semibold tracking-wide text-indigo-700 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-xl">
          ...
          <p className="animate-child animate-delay-3 mx-auto mt-7 max-w-3xl text-lg leading-8 text-slate-700 sm:text-xl">
          ...
          <div className="animate-child animate-delay-4 mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <button
              ...
              className="group relative w-full overflow-hidden rounded-full border border-indigo-100/80 bg-white/80 px-9 py-4 text-lg font-bold text-slate-900 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-xl transition-all duration-300 hover:scale-105 hover:border-cyan-300/70 hover:shadow-sm sm:w-auto"
            >
            ...
            <button
              ...
              className="w-full rounded-full border border-indigo-100/80 bg-white/80 px-9 py-4 text-lg font-semibold text-slate-900 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-xl transition-all duration-300 hover:scale-105 hover:border-purple-300/70 hover:bg-white/80 hover:shadow-sm hover:shadow-sm sm:w-auto"
            >
              Our Policies
            </button>
          </div>
          ...
          <div className="animate-child animate-delay-5 mx-auto mt-12 grid max-w-3xl grid-cols-1 gap-4 sm:grid-cols-3">
            <div className="rounded-2xl border border-indigo-100/80 bg-white/80 p-5 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-cyan-300/40 hover:shadow-sm">
            ...
            <div className="rounded-2xl border border-indigo-100/80 bg-white/80 p-5 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-purple-300/40 hover:shadow-sm">
            ...
            <div className="rounded-2xl border border-indigo-100/80 bg-white/80 p-5 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-blue-300/40 hover:shadow-sm">
          ...
          <div className="animate-child animate-delay-6 mt-12 flex flex-wrap justify-center gap-4 border-t border-white/50 pt-8">
            <button onClick={onOpenBlogModal} className="group flex items-center gap-2 rounded-full border border-indigo-100/80 bg-white/80 px-4 py-2 text-sm font-medium text-indigo-700 backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:border-white/50 hover:bg-white/80 hover:shadow-sm hover:text-slate-900">
            ...
            <button onClick={onOpenFreeModal} className="group flex items-center gap-2 rounded-full border border-indigo-100/80 bg-white/80 px-4 py-2 text-sm font-medium text-indigo-700 backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:border-white/50 hover:bg-white/80 hover:shadow-sm hover:text-slate-900">
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-white/70 transition-colors group-hover:bg-white/80 hover:shadow-sm">🎁</span>
              <span>Free Resources</span>
            </button>
            <button onClick={onOpenAnnouncementsModal} className="group flex items-center gap-2 rounded-full border border-indigo-100/80 bg-white/80 px-4 py-2 text-sm font-medium text-indigo-700 backdrop-blur-xl transition-all duration-300 hover:-translate-y-0.5 hover:border-white/50 hover:bg-white/80 hover:shadow-sm hover:text-slate-900">
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-white/70 transition-colors group-hover:bg-white/80 hover:shadow-sm">📢</span>
              <span>News</span>
            </button>
          </div>
