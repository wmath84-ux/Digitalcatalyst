              ...
              {view === 'hub' && (
                <div className="mx-auto max-w-7xl">
                  <div className="mb-10 max-w-3xl">
                    <h1 className="text-4xl font-black tracking-tight text-slate-900 sm:text-6xl">Daily Reading Hub</h1>
                    <p className="mt-5 text-lg leading-8 text-slate-600">A focused, dark-glass stream of news, blog insights, and official updates designed to keep students reading inside the app every day.</p>
                  </div>
