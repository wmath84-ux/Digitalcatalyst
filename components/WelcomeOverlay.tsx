...
const WelcomeOverlay: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-slate-950/55 backdrop-blur-2xl">
      <div className="rounded-[2rem] border border-white/25 bg-white/10 px-8 py-10 text-center text-white shadow-2xl">
